...
void setup() {
  ...
  dataFile.println("Temperature Amplifier Test Result");
  dataFile.println("*************************");
  // dataFile.println("Time (ms), PT1-I (psi), PT2-I (psi), PT3-I (psi), PT4-I (psi), PT5-I (psi), PT1-N (psi), PT1-O (psi), PT1-P (psi), PT1-T (psi), 
  //                   TT1-O (C), TT1-P (C), TT1-T (C), TT2-T (C), TT3-T (C)");
  dataFile.println("Time (ms), TT1-O (C), TT1-P (C), TT1-T (C), TT2-T (C), TT3-T (C)");
  dataFile.close();
